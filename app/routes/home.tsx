    ...
    <Layout>
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-sky-900 mb-8">
            Welcome to Your Digital Journey
          </h1>
          <p className="text-xl text-sky-800 mb-12 leading-relaxed">
            Discover how we can transform your ideas into reality with our
